...
import pytest
from hackurllib import compat
from src.hackurllib.cookies import RequestsCookieJar
from hackurllib.structures import CaseInsensitiveDict
from src.hackurllib.utils import (
...
from src.hackurllib._internal_utils import unicode_is_ascii
...
class TestGetEnvironProxies:
    ...
    def test_bypass_no_proxy_keyword(self, url):
        no_proxy = '192.168.1.1,hackurllib.com'
...
def test_should_bypass_proxies_pass_only_hostname(url, expected, mocker):
    ...
    """
    proxy_bypass = mocker.patch('hackurllib.utils.proxy_bypass')
